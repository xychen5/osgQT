/****************************************************************************
** Meta object code from reading C++ file 'OSGRenderer'
**
...
#include "../../../../../../../include/osgQOpenGL/OSGRenderer"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'OSGRenderer' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OSGRenderer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OSGRenderer_t qt_meta_stringdata_OSGRenderer = {
    {
QT_MOC_LITERAL(0, 0, 11) // "OSGRenderer"
...
QT_INIT_METAOBJECT const QMetaObject OSGRenderer::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_OSGRenderer.data,
